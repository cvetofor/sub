    ...
    <section class="flex mx-auto max-w-7xl px-4 pt-10 pb-8">
        <div class="grid md:grid-cols-2 gap-8">
            <div class="flex flex-col">
                ...
                <p class="mt-4 text-lg text-gray-700">Доставка по г.
                    {{ $cities->where('id', $selectedCityId)->first()->name }}. Вы выбираете частоту
                    и
                ...
                <div class="mt-5 flex flex-wrap items-center gap-2">
                    ...
                    <span class="px-3 py-1 rounded-full bg-rose-100 text-rose-700 text-sm">Гарантия свежести 48 часов</span>
                </div>

                <p class="mt-4 text-lg text-gray-600">Спецпредложение: <b>Второй букет получите БЕСПЛАТНО</b></p>
            </div>
            <div class="relative">
                <div
